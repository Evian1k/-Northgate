...
const heroStats = [
  { value: 9000, suffix: "+", label: "Students", decimals: 0 },
  { value: 150, suffix: "+", label: "Programmes", decimals: 0 },
  { value: 96, suffix: "%", label: "Graduate Employability", decimals: 0 },
  { value: 60, suffix: "+", label: "Years of Excellence", decimals: 0 },
];

export function Hero() {
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden gradient-hero">
      {/* Background image with overlay (acts as poster for video) */}
      <div className="absolute inset-0">
        {/* Use a premium engineering lab image as the ambient background */}
        <img
